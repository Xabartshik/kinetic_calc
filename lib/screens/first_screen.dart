...
class KineticEnergyForm extends StatefulWidget {
  const KineticEnergyForm({super.key});
              ...
              BlocBuilder<EnergyCubit, EnergyState>(
                builder: (context, state) {
                  return CheckboxListTile(
                    ...
                    title: const Text("Я готов слить свои данные за 0 рублей в общий доступ"),
                    onChanged: (value) {
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate() & state.isAgreed) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SecondScreen(mass: state.mass, speed: state.speed)
                          ),
                        );
                      }
                    }, 
